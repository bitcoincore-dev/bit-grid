...
- The UI renders a 16x16 bit grid, a header with the selected bit, a bottom Current State footer with the hex/WIF/address/verify summary, and an optional extra-info modal.
...
- The bottom footer should keep showing verification status plus a compact derivation summary; the popup should carry the longer explanatory text and the controls legend.
